...
export const validationSchema = Yup.object({
  ...
  porosityFore: Yup.number(),
  porosityAft: Yup.number(),
  porosityPort: Yup.number(),
  porosityStarboard: Yup.number(),
  wallAreaFore: Yup.number(),
  wallAreaAft: Yup.number(),
  wallAreaPort: Yup.number(),
  wallAreaStarboard: Yup.number(),
  inclinationFore: Yup.number(),
